...
class Trainer():
    ...
    def _save_loss_arrays(self, train_losses, train_aucs, train_accs, valid_losses, valid_aucs, valid_accs, test_losses, test_aucs, test_accs):
        np.save("./output/{self.name}/train_losses.npy", (train_losses))
        np.save("./output/{self.name}/train_aucs.npy", (train_aucs))
        np.save("./output/{self.name}/train_accs.npy", (train_accs))
        np.save("./output/{self.name}/valid_losses.npy", (valid_losses))
        np.save("./output/{self.name}/valid_aucs.npy", (valid_aucs))
        np.save("./output/{self.name}/valid_accs.npy", (valid_accs))
        np.save("./output/{self.name}/test_losses.npy", (test_losses))
        np.save("./output/{self.name}/test_aucs.npy", (test_aucs))
        np.save("./output/{self.name}/test_aucs.npy", (test_accs))
