...
if __name__ == "__main__":
    data, _ = get_ironmarch_network_data(threshold=5, load=False, loadBow=False, data_path="./data/ironmarch_5_bow_50000.pth")
    ...
    trainer = Trainer(model, optimizer, scheduler, device, "ironmarch_5_bow_5000")

    trainer.train(data, 5001)
